...
export async function SiteHeader() {
  ...
  const memberNavigation = signedIn ? <><Link className="nav-link" href="/dashboard">Dashboard</Link><form action={logout}><FormSubmitButton className="nav-login" pendingLabel="Signing out…">Sign out</FormSubmitButton></form></> : <Link className="nav-login" href="/login">Log in</Link>;
